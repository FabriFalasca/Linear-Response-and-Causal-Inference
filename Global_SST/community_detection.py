...
def community_detection(path, climate_variable, lon_variable, lat_variable, rand_samples_k, rand_samples_eta, q_k, q_eta, k=None):
        ...
        for i in range(n):
            ...
            for j in range(i+1, n):  # (i+1) means we do not include the diagonal in the calculation
                ...
                if corr_lag_zero >= k:
                    ...
                    distance_i_j = pairwise_distances(coords_notNaN[i,None],coords_notNaN[j,None],metric='haversine')[0,0]
